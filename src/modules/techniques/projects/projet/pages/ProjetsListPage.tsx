...
export const ProjetsListPage: React.FC = () => {
  ...
  const [projectPartnersMap, setProjectPartnersMap] = useState<
    Map<number, number[]>
  >(new Map());
  const { getProjetAssociatedPartenaires } = useProjetService();
  const { deleteProjetWithConfirmation } = useProjetService();
      ...
      try {
        ...
        if (result.success) {
          ...
          if (
            serverPagination &&
            currentPage > 1 &&
            serverPagination.total - 1 <= (currentPage - 1) * projetsPerPage
          ) {
      ...
      <div className="container mx-auto py-6 space-y-6">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            <Button
              onClick={() => navigate("/gestion-des-projets/projets/nouveau")}
            >
            ...
            {projets.length === 0 && !error ? (
              ...
              <>
                ...
                <ProjetTable
                  ...
                  onView={(id) =>
                    navigate(`/gestion-des-projets/projets/${id}/details`)
                  }
                  onEdit={(id) =>
                    navigate(`/gestion-des-projets/projets/${id}/editer`)
                  }
