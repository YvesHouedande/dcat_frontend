...
import { BookOpenCheck, FolderKanban } from 'lucide-react';
import { useNavigate } from 'react-router-dom';

export default function GestionsProjet() {
      ...
      <div className="w-full h-full flex flex-col p-4 md:p-6">
        <div className="flex-1 flex flex-col md:flex-row gap-4 md:gap-6 items-center">
          ...
          >
            ...
            <span className="text-xl">{"Projets/missions"}</span>
          </button>
          <button
            onClick={() => navigate("/gestion-des-projets/projets/livrables")}
          ...
          >
            ...
            <span className="text-xl">{"Livrable"}</span>
          </button>
        </div>
      </div>
    </Layout>
