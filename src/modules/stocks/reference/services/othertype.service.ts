...
export const useProductMarquesService = () => {
  ...
  const create = async (
    data: Omit<marqueTypes, "id_marque">
  ): Promise<marqueTypes> => {
...
export const useProductCategoriesService = () => {
  ...
  const create = async (
    data: Omit<categorieTypes, "id_categorie">
  ): Promise<categorieTypes> => {
...
export const useProductModelsService = () => {
  ...
  const getModeleByMarque = async (
    id: string | number
  ): Promise<modeleTypes[]> => {
    const response = await api.get(`/stocks/modeles/by-brand/${id}`);
    return response.data;
  };
  const create = async (
    data: Omit<modeleTypes, "id_modele">,
    marqueValue: string
  ): Promise<modeleTypes> => {
    const response = await api.post("/stocks/modeles", {
      ...data,
      id_marque: Number(marqueValue),
    });
    return response.data;
  };
  const update = async (
...
export const useProductFamiliesService = () => {
  ...
  const create = async (
    data: Omit<familleTypes, "id_famille">
  ): Promise<familleTypes> => {
...
export const useProductTypeService = () => {
  ...
  const create = async (
    data: Omit<typeTypes, "id_type_produit">
  ): Promise<typeTypes> => {
