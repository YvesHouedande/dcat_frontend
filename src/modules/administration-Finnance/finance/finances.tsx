...
export const documents: Document[] = [
  {
    id_document: 1,
    libele_document: "Rapport financier annuel 2024",
    lien_document: "rapport-financier-2024.pdf",
    etat_document: "actif",
  ...
  {
    id_document: 2,
    libele_document: "Présentation résultats trimestriels Q1 2024",
    lien_document: "resultats-trimestriels-q1-2024.pptx",
    etat_document: "actif",
  ...
  {
    id_document: 3,
    libele_document: "Budget prévisionnel 2025",
    lien_document: "budget-previsionnel-2025.xlsx",
    etat_document: "actif",
  ...
  {
    id_document: 4,
    libele_document: "Analyse des flux de trésorerie",
    lien_document: "analyse-flux-tresorerie.pdf",
    etat_document: "actif",
    id_nature_document: 1,
  ...
  {
    id_document: 5,
    libele_document: "Politique d'investissement",
    lien_document: "politique-investissement.docx",
    etat_document: "actif",
    id_nature_document: 2,
  ...
  {
    id_document: 6,
    libele_document: "Audit financier 2023",
    lien_document: "audit-financier-2023.pdf",
    etat_document: "actif",
    id_nature_document: 1,
  ...
  {
    id_document: 7,
    libele_document: "Tableau de bord indicateurs financiers",
    lien_document: "indicateurs-financiers.xlsx",
    etat_document: "actif",
    id_nature_document: 3,
  ...
  {
    id_document: 8,
    libele_document: "Contrat de prêt bancaire",
    lien_document: "contrat-pret-bancaire.pdf",
    etat_document: "actif",
    id_nature_document: 1,
  ...
  {
    id_document: 9,
    libele_document: "Procédures comptables",
    lien_document: "procedures-comptables.pdf",
    etat_document: "actif",
    id_nature_document: 1,
  ...
  {
    id_document: 10,
    libele_document: "Analyse risque crédit",
    lien_document: "analyse-risque-credit.pptx",
    etat_document: "actif",
    id_nature_document: 2,
...
const FinanceGrid: React.FC = () => {
  ...
  const handleAddDocument = () => {
    navigate("/administration/finance/nouveau");
  };

  const handleViewDocument = (id: number) => {
    navigate(`/administration/finance/${id}/details`);
  };
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-3">
          <div>
            <h1 className="text-xl font-bold text-gray-800">
              Annuaire des documents des Finances
            </h1>
