...
const DocFinance: React.FC = () => {
  ...
  const handleViewDocument = (id: number) => {
    navigate(`/finance-et-compatibilite/${activeTab}/${id}`, {
      state: {
        data: JSON.stringify(documents.find((doc) => doc.id_documents === id)),
      },
    });
  };
